...
import categories from "@/constants/filter.json"; // Ensure this path is correct
...
const ItemBox = () => (
  <>
    <View className="gap-3">
      ...
      <TouchableOpacity className="flex-row items-center justify-between px-5 py-2 border-b border-grey pl-7">
        <View className="flex-row gap-5 items-center">
          <Ionicons name="alarm" size={24} color={Colors.medium} />
      ...
      <TouchableOpacity className="flex-row items-center justify-between px-5 py-2 border-b border-grey pl-7">
        <View className="flex-row gap-5 items-center">
          <Ionicons name="people" size={22} color={Colors.medium} />
          <Text className="text-base font-medium text-mediumDark">
            Passenger Demand
          </Text>
        </View>
      ...
      <TouchableOpacity className="flex-row items-center justify-between px-5 py-2 border-b border-grey pl-7">
        <View className="flex-row gap-5 items-center">
          <Ionicons name="airplane" size={24} color={Colors.medium} />
          <Text className="text-base font-medium text-mediumDark">
            Road Conditions
          </Text>
        </View>
    ...
    <Text className="text-xl font-extrabold mt-6 mb-4 px-6">
      Real time Sorting
    </Text>
  </>
);
